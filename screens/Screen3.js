...
export default class Screen3 extends React.Component {
  ...
  componentDidMount(){
    this.text.measure((x, y, width, height, pageX, pageY)=>{
      this.setState({toVal: y})
    })
  }
  ...
  render(){
    return(
      <View style={{height: '100%', backgroundColor: '#00c48c'}}>
        ...
        <Text style={styles.description}>Click on an object to learn its word</Text>
        ...
        <Animated.View ref={view=>{this.text=view}} style={{flex: 1, width: '100%', justifyContent: 'center', top: this.textPos}}>            
